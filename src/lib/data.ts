...
export const notices: Notice[] = [
  {
    id: 1,
    title: "[긴급] 2026년 정기 학술대회 개최 안내",
    date: "2026.01.25",
    content: "제9회 대한혈관외과학회 혈액투석길 연구회가 2026년 1월 25일 대구가톨릭대학교 의과대학 (루가관) 7층 강당에서 개최됩니다.",
    isNew: true,
    category: "공지",
    priority: "긴급",
  },
  ...
  {
    id: 4,
    title: "[공지] 제10회 HAM 정기 학술대회 개최 안내 (2026.04.25)",
    date: "2026.02.08",
    content: "제10회 대한혈관외과학회 혈액투석길 연구회가 2026년 4월 25일(토) 충남대학교 병원 강당에서 15:00~18:30 진행됩니다.",
    isNew: true,
    category: "공지",
    priority: "중요",
  },
